...
func Test_CaptureEnPassant(t *testing.T) {
	game, err := NewSimpleFourPlayerGame()
	assert.Nil(t, err)

    err = game.Execute(3, 12, 3, 10, "") // white pawn advance
    assert.Nil(t, err)

    err = game.Execute(1, 9, 3, 9, "") // black pawn advance
    assert.Nil(t, err)

    err = game.Execute(10, 1, 10, 3, "") // red pawn advance
    assert.Nil(t, err)

    err = game.Execute(12, 4, 10, 4, "") // blue pawn advance
    assert.Nil(t, err)

    err = game.Execute(3, 10, 2, 9, "") // white capture en passant
    assert.Nil(t, err)
...
|XXXXXXXXXXXX|XXXXXXXXXXXX|XXXXXXXXXXXX| R 2        | N 2        | B 2        | Q 2        | K 2        | B 2        | N 2        | R 2        |XXXXXXXXXXXX|XXXXXXXXXXXX|XXXXXXXXXXXX|
...
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|         0x |         1x |         2x |         3x |         4x |         5x |         6x |         7x |         8x |         9x |        10x |        11x |        12x |        13x |
|XXXXXXXXXXXX|XXXXXXXXXXXX|XXXXXXXXXXXX| R 0        | N 0        | B 0        | Q 0        | K 0        | B 0        | N 0        | R 0        |XXXXXXXXXXXX|XXXXXXXXXXXX|XXXXXXXXXXXX|
