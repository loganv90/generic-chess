...
func Test_Minimax_AvoidMateInOne(t *testing.T) {
    ...
    assert.Nil(t, err)
    b.setPiece(Point{5, 4}, Piece{white, QUEEN})
    b.setPiece(Point{5, 3}, Piece{white, QUEEN})
    b.setPiece(Point{3, 2}, Piece{black, PAWN_D_M})
    b.setPiece(Point{6, 0}, Piece{0, 0})
    err = b.CalculateMoves()
    assert.Nil(t, err)
...
func Benchmark_Minimax(t *testing.B) {
    ...
    for i := 0; i < t.N; i++ {
        ...
        b.setPiece(Point{0, 0}, Piece{black, QUEEN})
        b.setPiece(Point{3, 0}, Piece{black, KING_U})
        b.setPiece(Point{6, 0}, Piece{black, QUEEN})

        b.setPiece(Point{2, 1}, Piece{black, KNIGHT})
        b.setPiece(Point{3, 1}, Piece{black, QUEEN})
        b.setPiece(Point{4, 1}, Piece{black, KNIGHT})
        b.setPiece(Point{7, 1}, Piece{black, BISHOP})

        b.setPiece(Point{1, 2}, Piece{black, KNIGHT})
        b.setPiece(Point{3, 2}, Piece{white, PAWN_U})
        b.setPiece(Point{5, 2}, Piece{black, KNIGHT})
        b.setPiece(Point{7, 2}, Piece{black, BISHOP})

        b.setPiece(Point{2, 3}, Piece{black, ROOK})
        b.setPiece(Point{3, 3}, Piece{black, KNIGHT})
        b.setPiece(Point{4, 3}, Piece{black, ROOK})
        b.setPiece(Point{7, 3}, Piece{white, QUEEN})

        b.setPiece(Point{1, 4}, Piece{white, KNIGHT})
        b.setPiece(Point{2, 4}, Piece{white, QUEEN})
        b.setPiece(Point{4, 4}, Piece{white, QUEEN})
        b.setPiece(Point{5, 4}, Piece{white, KNIGHT})
        b.setPiece(Point{7, 4}, Piece{white, QUEEN})

        b.setPiece(Point{3, 5}, Piece{white, QUEEN})
        b.setPiece(Point{7, 5}, Piece{white, BISHOP})

        b.setPiece(Point{2, 6}, Piece{white, ROOK})
        b.setPiece(Point{3, 6}, Piece{white, QUEEN})
        b.setPiece(Point{4, 6}, Piece{white, ROOK})
        b.setPiece(Point{7, 6}, Piece{white, BISHOP})

        b.setPiece(Point{0, 7}, Piece{white, QUEEN})
        b.setPiece(Point{3, 7}, Piece{white, KING_U})
